<template>
  <div>
    <van-nav-bar
      ...
      @click-right="$router.push('/school-bus-pro/order/list/waiting-ride')"
    />
...
<script>
  ...
  import {ordePay} from "../../network/schoolBusPro";
  ...
  export default {
    ...
    created() {
      ...
      // 从哪来回哪去
      if (this.$route.query.from == null) this.path = "/main/school-bus-pro"
