...
<script>
    ...
    export default {
        ...
        created() {
            get_user('eyJhbGciOiJIUzUxMiIsImlhdCI6MTU3MTg0ODg3NywiZXhwIjoxNTcxODUyNDc3fQ.eyJpZCI6MTcyMDE3NTYxLCJ2YWxpZGF0ZV9lbWFpbCI6dHJ1ZSwic2Nob29sX2J1cyI6ZmFsc2UsImFkbWluIjpmYWxzZX0.KrOED6IJ8Mhl8nP9DxDwbVE9tZq92NRdnB0IZAu02RHDma1ml9RZ0dm8zI74I0cwDjR-yl4naZBd576HSl6j_A')
                .then(res => {
